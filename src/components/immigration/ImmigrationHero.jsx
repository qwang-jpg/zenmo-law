  ...
  return (
    <section className="relative w-full flex items-center overflow-hidden min-h-[460px] md:min-h-[500px]">
      ...
      <div className="relative z-10 max-w-content mx-auto w-full px-5 md:px-8 lg:px-0 py-16 md:py-20">
        ...
        >
          The U.S. immigration system is complex and constantly evolving. Zenmo Law centers its practice on holistic pathway design and continuous compliance — developing immigration strategies aligned with each client's personal or business trajectory.
        </motion.p>
      </div>
    </section>
  )
