...
const numbers = [
  { num: '01', title: 'Strategy First', desc: 'Tailored pathways, not template solutions' },
  { num: '02', title: 'Full Transparency', desc: 'Clear milestones, trackable progress' },
  { num: '03', title: 'Long-Term Support', desc: 'Ongoing guidance to manage risk' },
]
