...
const steps = [
  {
    ...
    title: 'Assessment & Goal Clarification',
    desc: 'We systematically assess your background and objectives to identify viable pathways and key risk factors.',
  },
  {
    number: '02',
    icon: <CheckSquare size={22} strokeWidth={1.8} />,
    title: 'Strategy & Plan Confirmation',
    desc: 'We discuss execution strategy with you in depth so you can make informed decisions with full clarity.',
  },
  {
    number: '03',
    icon: <FileText size={22} strokeWidth={1.8} />,
    title: 'Document & Process Management',
    desc: 'We maintain rigorous control over document quality and critical deadlines to keep every matter on track.',
  },
  {
    number: '04',
    icon: <Users size={22} strokeWidth={1.8} />,
    title: 'Ongoing Support & Compliance',
    desc: 'After each milestone, we continue to advise on status maintenance, compliance, and long-term planning.',
  },
]
